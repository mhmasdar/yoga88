...
import com.technologygroup.rayannoor.yoga.adapters.KaryabAdapter;
 ...
 */
public class KaryabFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_karyab, container, false);
    ...
    private void setUpRecyclerView(){
        KaryabAdapter adapter = new KaryabAdapter(getActivity(),list);
    ...
    private class WebServiceList extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            list = webService.getZanguleKaryabi(App.isInternetOn());
            return null;
        }
