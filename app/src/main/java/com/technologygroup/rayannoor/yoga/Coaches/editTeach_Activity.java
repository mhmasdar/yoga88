...
public class editTeach_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idCoach = getIntent().getIntExtra("idRow", -1);
            ...
            idteach = getIntent().getIntExtra("idteach", -1);

        WebServiceEdit webServiceEdit= new WebServiceEdit();
        ...
        lytSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!edtTitle.getText().toString().equals("")) {
                    ...
                    Toast.makeText(editTeach_Activity.this, "عنوان وارد نشده است", Toast.LENGTH_LONG).show();
                }
            ...
            public void onClick(View v) {
                ...
                if (flagPermission) {
                    ...
                    if (App.isInternetOn()) {
                        ...
                        Toast.makeText(editTeach_Activity.this, "به اینترنت متصل نیستید", Toast.LENGTH_LONG).show();
                    }
                }
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == PICK_FILE_REQUEST) {
                ...
                if (selectedFilePath.get(requestCode) != null && !selectedFilePath.get(requestCode).equals("")) {
                    ...
                    editTeach_Activity.CallBackFile callBackFile=new editTeach_Activity.CallBackFile();
    ...
    private class AddTrain extends AsyncTask<Object, Void, Void> {
        ...
        org.json.JSONArray jsonArrayImage;
        JSONArray JSONArray;
        String lastUpdate;
        String result;
...
//            dialog.dismiss();
            if(result!=null) {
                if (result.equals("OK")) {
                    Toast.makeText(editTeach_Activity.this, "با موفقیت اضافه شد", Toast.LENGTH_SHORT).show();
                    finish();

                } else {
                    Toast.makeText(editTeach_Activity.this, "نا موفق", Toast.LENGTH_SHORT).show();
                }
            }
            else
            {
...
//            dialog.dismiss();
    ...
    private class WebServiceEdit extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            list = webService.getMoves(App.isInternetOn(), idteach);
            return null;
        }
    ...
    public void settexts()
    {
        ...
        for(int i=0;i<list.size();i++)
        {
            ...
            imgTeach[i].setVisibility(View.VISIBLE);
            txtNoImage[i].setVisibility(View.GONE);
            lytTeach[i].setVisibility(View.VISIBLE);
            edtBody[i].setText(list.get(i).Text);
            if (list.get(i).Image != null)
                if (!list.get(i).Image.equals("") && !list.get(i).Image.equals("null"))
                    Glide.with(this).load(App.imgAddr + list.get(i).Image).asBitmap().diskCacheStrategy(DiskCacheStrategy.SOURCE).into( imgTeach[i]);
