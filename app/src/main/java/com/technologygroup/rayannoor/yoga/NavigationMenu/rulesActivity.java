...
public class rulesActivity extends AppCompatActivity {
    ...
    private class getRules extends AsyncTask<Object, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog1 = new Dialog(rulesActivity.this);
        ...
        protected Void doInBackground(Object... params) {
            ...
            result = webService.getAboutUs(App.isInternetOn() , "terms");
    ...
    public void onStop() {
        ...
        if (rules != null)
            if (rules.getStatus() == AsyncTask.Status.RUNNING)
                rules.cancel(true);
    }
}
